...
public class CheckinCreateView {
    private BorderPane root = new BorderPane();
    private InventoryController controller;
    private AdminView view;
    private Product product;

	public CheckinCreateView(AdminView view, Product product) {
		this.view = view;
	...
	private void init() {
        Label label = new Label("Check-In " + product.getName() + " to Inventory");
        ...
        TextField buyingPriceField = ViewUtil.createTextFieldWithText("0.0");
        ...
        // Submit button
        Button submitButton = new Button("CHECK-IN PRODUCT");
            ...
            if (!quantityField.getText().isBlank() && 
                ...
                try {
                    ...
                    if (validator.isValid()) {
                        controller.checkinInventory(item);
